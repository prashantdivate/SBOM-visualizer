...
/*
 * change the color of offerings-text
 */
export const useTypingText = (words, keySpeed = 1000, maxPauseAmount = 4 ,color='#0d47a1 ') => {
  ...
  return {
    word: (
      <span style={{ color: color }}>
        <strong>{currentWord.length ? currentWord.join("") : ""}</strong>
      </span>
    ),
